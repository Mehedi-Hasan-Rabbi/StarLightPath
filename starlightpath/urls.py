"""
URL configuration for starlightpath project.
...
urlpatterns = [
    ...
    path('api/application/', include('application.urls')),             # Application App
    path('api/program/', include('program.urls')),                     # Program App
